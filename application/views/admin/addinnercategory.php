...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> Inner category Management </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo admin_url().'category';?>"><i class="fa fa-dashboard"></i> Home</a></li>
      <li ><a href="<?php echo admin_url().'innercategory';?>">Inner category Managmenet</a></li>
      <li class="active"><?php echo $add;?> Inner category </li>
    </ol>
  </section>
      ...
      <div class="col-xs-8 ">
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo $add;?> Inner category </h3>
          </div>
          <!-- /.box-header --> 
          <!-- form start --> 
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
			   ...
			   <span class="marked">(Sub Category marked in English will display in this dropdown).</span>
                <span class="field_error"><?php echo form_error('subcategory_id');?></span> </div>
            </div>

            <div class="form-group">
              <label class="col-sm-3 control-label">Inner category (English)</label>
              <div class="col-sm-9">
                <input type="text"  class="form-control" name="innercategory" placeholder="Enter Inner category Name" value="<?php if(!empty($innercategory_data[0]['innercategory'])){ echo $innercategory_data[0]['innercategory']; } ?>" >
                <span class="field_error"><?php echo form_error('innercategory');?></span> </div>
            </div>
         
  
				<div class="form-group">
					<label class="col-sm-3 control-label">Inner category (French)</label>
					<div class="col-sm-9">
						<input type="text"  class="form-control" name="fr_innercategory" placeholder="Enter French Inner category  Name" value="<?php
						if (!empty($innercategory_data[0]['fr_innercategory'])) {
							echo $innercategory_data[0]['fr_innercategory'];
						}
						?>" >
						<span class="field_error"><?php echo form_error('fr_innercategory'); ?></span> </div>
				</div>
				<div class="form-group">
				<label class="col-sm-3 control-label">Inner category (Dutch) </label>
				<div class="col-sm-9">
					<input type="text"  class="form-control" name="dut_innercategory" placeholder="Enter Dutch Inner category Name" value="<?php
					if (!empty($innercategory_data[0]['dut_innercategory'])) {
						echo $innercategory_data[0]['dut_innercategory'];
					}
					?>" >
