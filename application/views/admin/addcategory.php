                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Category Name (English)</label>
                            <div class="col-sm-9">
                                <input type="text"  class="form-control" name="category" placeholder="Enter English Category Name" value="<?php
					   ...
					   <div class="form-group">
                            <label class="col-sm-3 control-label">Category Name (French)</label>
                            <div class="col-sm-9">
                                <input type="text"  class="form-control" name="fr_category" placeholder="Enter French Category Name" value="<?php
                                if (!empty($category_data[0]['fr_category'])) {
                                    echo $category_data[0]['fr_category'];
                                }
                                ?>" >
                                <span class="field_error"><?php echo form_error('fr_category'); ?></span> </div>
                        </div>
						 <div class="form-group">
                            <label class="col-sm-3 control-label">Category Name (Dutch)</label>
                            <div class="col-sm-9">
                                <input type="text"  class="form-control" name="dut_category" placeholder="Enter Dutch Category Name" value="<?php
                                if (!empty($category_data[0]['dut_category'])) {
                                    echo $category_data[0]['dut_category'];
                                }
                                ?>" >
                                <span class="field_error"><?php echo form_error('dut_category'); ?></span> </div>
                        </div>
