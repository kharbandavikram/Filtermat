<aside class="main-sidebar"> 
  ...
  <!--  <div class="user-panel">
    ...
    <ul class="sidebar-menu">
     <li class="active first_lisidebar">
     
      <!--<li class="<?php if((isset($leftbar_active)) && (($leftbar_active=='universalcategory')||($leftbar_active=='category')||($leftbar_active=='popularcategorylisting')||($leftbar_active=='subcategory')||($leftbar_active=='innercategory'))){echo "active";}?> treeview">--> 
	  
	 <!--<a href="#"> <i class="fa fa-building"></i> <span>Manage Category</span> <i class="fa fa-angle-left pull-right"></i> </a>-->
        <ul class="treeview-menu">
          <li><h5 class="manage_adminH">Manage Admin</h5> </li>
          <li class="<?php if($leftbar_active=='category'){echo 'active';}?>"><a href="<?php echo admin_url().'category'; ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i> Add/Edit Categories</a></li>
          <li class="<?php if($leftbar_active=='subcategory'){echo 'active';}?>"><a href="<?php echo admin_url().'subcategory'; ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i> Add/Edit Sub Categories</a></li>
          <li class="<?php if($leftbar_active=='innercategory'){echo 'active';}?>"><a href="<?php echo admin_url().'innercategory'; ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i> Add/Edit Inner Categories</a></li>
		  
		  
		  <li class="<?php if($leftbar_active=='products'){echo 'active';}?>"><a href="<?php echo admin_url().'products'; ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i> Add/Edit Products</a></li>
          
		  <li class="<?php if($leftbar_active=='search'){ echo 'active'; } ?>"><a href="<?php echo admin_url().'search'; ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i> View Product Description</a></li>
