<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Inner category  Managmenet</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">All Inner category </h3>
            <a href="<?php echo admin_url().'addinnercategory';?>">
            <button class="btn btn-success" style="float:right;">Add Inner category</button>
            </a> </div>
          <!-- /.box-header -->
          <div class="box-body">
