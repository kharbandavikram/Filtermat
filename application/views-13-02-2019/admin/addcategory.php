                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">English Category Name</label>
                            <div class="col-sm-9">
					   ...
					   <div class="form-group">
                            <label class="col-sm-3 control-label">Franch Category Name</label>
                            <div class="col-sm-9">
                                <input type="text"  class="form-control" name="fr_category" placeholder="Enter Franch Category Name" value="<?php
						 ...
						 <div class="form-group">
                            <label class="col-sm-3 control-label">Dutch Category Name</label>
                            <div class="col-sm-9">
