...
<div class="content-wrapper"> 
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li ><a href="<?php echo admin_url() . 'subcategory'; ?>">Subcategory Managmenet</a></li>
            ...
            <div class="col-xs-8 ">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $add; ?> Subcategory </h3>
                    </div>
                    <!-- /.box-header --> 
                    <!-- form start --> 
...
// debug($add);
                    ...
                    <div class="box-body">
                        ...
                        ?>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">English Subcategory</label>
                            <div class="col-sm-9">
                                <input type="text"  class="form-control" name="subcategory" placeholder="Enter Subcategory Name" value="<?php
						...
						<div class="form-group">
                            <label class="col-sm-3 control-label">Franch Subcategory</label>
                            <div class="col-sm-9">
                                <input type="text"  class="form-control" name="fr_subcategory" placeholder="Enter Franch subcategory Name" value="<?php
						 ...
						 <div class="form-group">
                            <label class="col-sm-3 control-label">Dutch Subcategory </label>
                            <div class="col-sm-9">
                                <input type="text"  class="form-control" name="dut_subcategory" placeholder="Enter Dutch subcategory Name" value="<?php
