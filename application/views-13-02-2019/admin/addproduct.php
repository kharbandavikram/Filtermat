                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="box-body">
							...
							<?php } ?>
							<div class="form-group">
								<label class="col-sm-3 control-label">English Product Name</label>
								<div class="col-sm-9">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">Franch Product Name</label>
							<div class="col-sm-9">
								<input type="text"  class="form-control" name="fr_product_name" placeholder="Enter Franch Product  Name" value="<?php
						...
						<div class="form-group">
						<label class="col-sm-3 control-label">Dutch Product Name</label>
						<div class="col-sm-9">
                            ...
                            <div class="col-sm-9">
                                <input type="radio" name="data_type" class="radio_button" value="1" <?php if(@$product_data[0]['data_type'] == 1){ echo 'checked';}?>> PDF 
						...
						<div class="form-group data_des"  style="display:<?php if( @$product_data[0]['data_type'] == 2){ echo'block';}else{ echo 'none';}?>" >
                            <label class="col-sm-3 control-label"> Franch Product Data</label>
                            <div class="col-sm-9">
						...
						<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text"  class="form-control" name="product_text_button" placeholder="Enter Product Button" value="<?php
