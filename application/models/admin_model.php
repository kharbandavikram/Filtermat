...
/*****************************************end Manage event*************************************************/
  ...
  public function all_category(){
	  $query=$this->db->order_by('id','asc')->get('tbl_category')->result();
	  return $query; 
  }
  ...
  public function single_post($id){
   ...
   public function get_navigation_menu(){
	...
	public function innercategory($catid,$subcatid){
		...
		$res_query="select id,innercatimage,innercategory as name,fr_innercategory,dut_innercategory,1 as type from tbl_innercategory where  status=1 and subcategory_id ='".$subcatid."' order by innercategory asc";
		...
		$res_query="select id,product_name as name,2 as type,product_text_button,fr_product_name,productimage,dut_product_name from tbl_products where  status=1 and subcategory_id ='".$subcatid."' AND innercategory_id = 0 order by product_name asc";
		$product=$this->db->query($res_query)->result_array();
		return $product;
